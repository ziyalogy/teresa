...
?>
<div id="mod-articles-<?php echo $module->id; ?>" class="mod-media-grid <?php echo $modTitle.' '.$moduleclass_sfx; ?>" >
	<div class="grid-wrap">
		<?php if ($grouped) : ?>
		...
		<?php else : ?>
			<?php $i=1; foreach ($list as $item) : ?>
				...
				<?php if($i<=2) :?>
					<div class="item-<?php echo ($i==1) ? 'highlight' : 'child row row-cols-1 row-cols-md-2 v-gutters' ;?>" >
				<?php endif;?>
