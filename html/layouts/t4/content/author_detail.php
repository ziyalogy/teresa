...
<div class="author-block <?php echo $cls; ?> detail-block ">
    ...
    <?php if(!empty($proParams->get('phone'))): ?>
      ...
      <div>
        <h4>Phone</h4>
        <span><?php echo $proParams->get('phone'); ?></span>
      </div>
    </div>
		<?php endif ?>

    <?php if(!empty($proParams->get('address1')) || !empty($proParams->get('city')) || !empty($proParams->get('country'))) : ?>
		<div class="author-address">
      <div><i class="fas fa-map-marker-alt"></i></div>
      <div>
        <h4>Address</h4>
        <span><?php echo $proParams->get('address1'); ?><i style="margin: 0"> - </i></span>
        <span><?php echo $proParams->get('city'); ?><i style="margin: 0"> - </i></span>
        <span><?php echo $proParams->get('country'); ?></span>
      </div>
    </div>
		<?php endif ?>
